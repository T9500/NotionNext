...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '白白快好了', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在还没好和快好了之间切换', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bbai.twipce.com', // 网站地址
